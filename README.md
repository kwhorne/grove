...
[![Platform](https://img.shields.io/badge/platform-macOS%20%7C%20Linux%20(beta)-lightgrey.svg)](docs/INSTALL.md#linux-beta)
...
- 🗄️ **Bundled services** — Grove downloads and supervises PostgreSQL, MySQL, [ElyraSQL](https://github.com/kwhorne/ElyraSQL) and Redis itself, so there is no database/cache or Homebrew to install separately. ElyraSQL is a single-binary, single-file MySQL-compatible server: your Laravel `.env` says `DB_CONNECTION=mysql` and nothing else changes.
